...
<div class="exp-card">
  ...
  <p style="font-style:italic; font-size:0.9em; color: var(--global-text-color-light);">MHFusionNet: Multiple Hypotheses Fusion-Based Approaches for 3D Human Pose Estimation</p>
  <ul>
...
<div class="exp-card">
  ...
  <p style="font-style:italic; font-size:0.9em; color: var(--global-text-color-light);">Sim-to-Real Reinforcement Learning for Robot Navigation</p>
  <ul>
...
<div class="exp-card">
  ...
  <p style="font-style:italic; font-size:0.9em; color: var(--global-text-color-light);">Robot Navigation using ROS2 and Nav2 Framework</p>
  <ul>
...
<div class="exp-card">
  <h3>R&D &mdash; Cambodian Sign Language Recognition and Translation</h3>
